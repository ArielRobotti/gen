...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    <StarsBackground stars ={800} parallaxIntensity={0.05} maxSize={0.8}/>
    <StarsBackground stars ={600} parallaxIntensity={0.1} maxSize={1.2}/>
    <StarsBackground stars ={400} parallaxIntensity={0.12} maxSize={1.4}/>
